...
import { Booking, CollectionCenter } from '../types';
...
export function BookingsScreen() {
  ...
  return (
    <Screen safeAreaEdges={nestedScreenEdges}>
      ...
      <Subtitle>Trova un centro sulla mappa e prenota uno slot per la tua donazione.</Subtitle>
      ...
      <Card>
        ...
        {sortedBookings.length === 0 ? (
          ...
          <>
            <Muted>Scorri una prenotazione verso sinistra per eliminarla.</Muted>

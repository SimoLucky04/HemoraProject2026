...
export function AdminToolsScreen() {
  ...
  return (
    <Screen safeAreaEdges={nestedScreenEdges}>
      <Title>Strumenti demo</Title>
      <Subtitle>Pannello admin per popolare e testare tutte le funzionalità dell'app.</Subtitle>
      ...
      <Card>
        ...
        <AppButton title="Crea prenotazione futura (tra 7 gg)" onPress={handleFutureBooking} variant="secondary" />
        <AppButton title="Crea prenotazione scaduta → storico" onPress={handleDueBooking} variant="secondary" />
      </Card>

      <Card>
        <SectionTitle>Notifiche e popup (in-app)</SectionTitle>
        <AppButton title="Invia notifica emergenza" onPress={handleEmergency} variant="secondary" />
        <AppButton title="Forza popup “Ora puoi donare”" onPress={handleForcePopup} variant="secondary" />
      </Card>
